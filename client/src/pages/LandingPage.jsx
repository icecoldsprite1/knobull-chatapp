      ...
      {!showLoginForm ? (
        <div className="w-full max-w-2xl grid md:grid-cols-2 gap-6 relative z-10">
          ...
          {/* 
            ...
            Directly invokes the `onStartStudent` anonymous login flow from App.jsx 
          */}
          <button 
            onClick={onStartStudent} 
            className="flex flex-col p-8 bg-blue-600 border border-blue-500 rounded-2xl shadow-lg shadow-blue-900/10 hover:-translate-y-1 hover:shadow-xl hover:bg-blue-700 transition-all duration-300 text-left group"
          >
            <div className="w-14 h-14 bg-blue-500/30 rounded-xl text-white flex items-center justify-center mb-6">
              <BookOpen size={28} />
            </div>
            <h2 className="text-2xl font-serif font-semibold text-white mb-2">Student Access</h2>
